...
I'm basically just making little changes to this particular post, then committing those changes to Github. This in turn triggers a Jenkins build process which deploys the Jekyll site to Stackato with a unique URL **and** the '[blog.troytop.net](http://blog.troytop.net)' URL. If you refresh this page using the 'blog.troytop.net' URL, you should see various versions of it at random because each version is added to a load balanced pool.
